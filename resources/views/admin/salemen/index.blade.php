...
@endsection
@section('content')
    <div class="row" ng-app="salemenApp" ng-controller="salemenController" ng-cloak>
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="col-md-2 text-right">
                        <button type="button" ng-click="loadModal()" class="btn btn-primary btn-sm">Add new SaleMen</button>
                    </div>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tbody>
                        <tr dir-paginate="record in Salemen|orderBy:sortKey:reverse|filter:search|itemsPerPage:10">
                        ...
                        <div class="modal-content border-radius">
                            ...
                            <div class="modal-body">
                                <form ng-submit="submitForm()" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-4">Select Area:</label>
                                        <div class="col-sm-8">
                                            <select class="form-control" name="area_id" ng-model="newData.area_id"
                                                ng-options="row.id as row.area_name for row in areas" required>
...
@section('script')
    <script src="{{ asset('/js/salemen.js') }}"></script>
    <script src="{{ asset('/js/dirPagination.js') }}"></script>
    <script>
        myApp.constant("CSRF_TOKEN", '{!! csrf_token() !!}')
        myApp.constant("area_id", '0')
    </script>
    <script src="{{ asset('/js/controller/salemenController.js') }}"></script>
    <script src="{{ asset('/js/service/salemenService.js') }}"></script>
@endsection