...
@endsection
@section('content')
    <div class="row" ng-app="stockApp" ng-controller="stockController" ng-cloak>
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="col-md-2 text-right">
                        <button type="button" ng-click="loadModal()" class="btn btn-primary btn-sm">Add new stock</button>
                    </div>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <table id="example2" class="table table-bordered table-hover">
                        <thead>
                        <tr>
                            <th ng-click="sort('product_name')" class="cursor-pointer">Product name
                            ...
                            <div class="modal-body">
                                <form ng-submit="submitForm()" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="product_name" ng-model="newData.product_name" placeholder="Product name" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
@section('script')
    <script src="{{ asset('/js/stockapp.js') }}"></script>
