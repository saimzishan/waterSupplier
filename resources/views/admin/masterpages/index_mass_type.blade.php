            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="col-md-2 text-right">
                        <button type="button" ng-click="loadModal()" class="btn btn-primary btn-sm">{{ trans('list.addNewMassType') }}</button>
                    </div>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            <thead>
                            <tr>
                                <th ng-click="sort('value')" class="cursor-pointer">{{ trans('list.massTypes') }}
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content border-radius">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" ng-if="newData.id">{{ trans('list.update') }} {{ trans('list.massType') }}</h4>
                                <h4 class="modal-title" ng-if="!newData.id">{{ trans('list.addNewMassType') }}</h4>
                            </div>
                            <div class="modal-body">
                                <form ng-submit="submitForm()" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-4" for="value">{{ trans('list.addNewMassType') }}:</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="value" ng-model="newData.value" placeholder="{{ trans('list.massType') }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
